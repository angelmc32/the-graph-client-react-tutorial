...
export type GetManySwapsQueryVariables = Exact<{
    [key: string]: never;
}>;
export type GetManySwapsQuery = {
    swaps: Array<(Pick<Swap, 'id' | 'amountUSD' | 'timestamp'> & {
        pair: (Pick<Pair, 'token0Price' | 'token1Price'> & {
            token0: Pick<Token, 'name' | 'symbol'>;
            token1: Pick<Token, 'name' | 'symbol'>;
        });
    })>;
};
...
export declare const GetManySwapsDocument: DocumentNode<GetManySwapsQuery, Exact<{
    [key: string]: never;
}>>;
