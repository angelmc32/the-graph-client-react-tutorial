...
export type Market_orderBy = 'borrowRate' | 'cash' | 'collateralFactor' | 'exchangeRate' | 'interestRateModelAddress' | 'name' | 'reserves' | 'supplyRate' | 'symbol' | 'id' | 'totalBorrows' | 'totalSupply' | 'underlyingAddress' | 'underlyingName' | 'underlyingPrice' | 'underlyingSymbol' | 'accrualBlockNumber' | 'blockTimestamp' | 'borrowIndex' | 'reserveFactor' | 'underlyingPriceUSD' | 'underlyingDecimals';
...
export type AccountCToken_orderBy = 'id' | 'market' | 'market__borrowRate' | 'market__cash' | 'market__collateralFactor' | 'market__exchangeRate' | 'market__interestRateModelAddress' | 'market__name' | 'market__reserves' | 'market__supplyRate' | 'market__symbol' | 'market__id' | 'market__totalBorrows' | 'market__totalSupply' | 'market__underlyingAddress' | 'market__underlyingName' | 'market__underlyingPrice' | 'market__underlyingSymbol' | 'market__accrualBlockNumber' | 'market__blockTimestamp' | 'market__borrowIndex' | 'market__reserveFactor' | 'market__underlyingPriceUSD' | 'market__underlyingDecimals' | 'symbol' | 'account' | 'account__id' | 'account__countLiquidated' | 'account__countLiquidator' | 'account__hasBorrowed' | 'transactions' | 'accrualBlockNumber' | 'enteredMarket' | 'cTokenBalance' | 'totalUnderlyingSupplied' | 'totalUnderlyingRedeemed' | 'accountBorrowIndex' | 'totalUnderlyingBorrowed' | 'totalUnderlyingRepaid' | 'storedBorrowBalance';
...
export type AccountCTokenTransaction_orderBy = 'id' | 'account' | 'account__id' | 'account__symbol' | 'account__accrualBlockNumber' | 'account__enteredMarket' | 'account__cTokenBalance' | 'account__totalUnderlyingSupplied' | 'account__totalUnderlyingRedeemed' | 'account__accountBorrowIndex' | 'account__totalUnderlyingBorrowed' | 'account__totalUnderlyingRepaid' | 'account__storedBorrowBalance' | 'tx_hash' | 'timestamp' | 'block' | 'logIndex';
...
export type MintEvent_orderBy = 'id' | 'amount' | 'to' | 'from' | 'blockNumber' | 'blockTime' | 'cTokenSymbol' | 'underlyingAmount';
...
export type RedeemEvent_orderBy = 'id' | 'amount' | 'to' | 'from' | 'blockNumber' | 'blockTime' | 'cTokenSymbol' | 'underlyingAmount';
...
export type LiquidationEvent_orderBy = 'id' | 'amount' | 'to' | 'from' | 'blockNumber' | 'blockTime' | 'cTokenSymbol' | 'underlyingSymbol' | 'underlyingRepayAmount';
...
export type BorrowEvent_orderBy = 'id' | 'amount' | 'accountBorrows' | 'borrower' | 'blockNumber' | 'blockTime' | 'underlyingSymbol';
...
export type RepayEvent_orderBy = 'id' | 'amount' | 'accountBorrows' | 'borrower' | 'blockNumber' | 'blockTime' | 'underlyingSymbol' | 'payer';
...
export type UnderlyingTransfer_orderBy = 'id' | 'amount' | 'accountBorrows' | 'borrower' | 'blockNumber' | 'blockTime' | 'underlyingSymbol';
...
export type Burn_orderBy = 'id' | 'transaction' | 'transaction__id' | 'transaction__blockNumber' | 'transaction__timestamp' | 'timestamp' | 'pair' | 'pair__id' | 'pair__reserve0' | 'pair__reserve1' | 'pair__totalSupply' | 'pair__reserveETH' | 'pair__reserveUSD' | 'pair__trackedReserveETH' | 'pair__token0Price' | 'pair__token1Price' | 'pair__volumeToken0' | 'pair__volumeToken1' | 'pair__volumeUSD' | 'pair__untrackedVolumeUSD' | 'pair__txCount' | 'pair__createdAtTimestamp' | 'pair__createdAtBlockNumber' | 'pair__liquidityProviderCount' | 'liquidity' | 'sender' | 'amount0' | 'amount1' | 'to' | 'logIndex' | 'amountUSD' | 'needsComplete' | 'feeTo' | 'feeLiquidity';
...
export type LiquidityPosition_orderBy = 'id' | 'user' | 'user__id' | 'user__usdSwapped' | 'pair' | 'pair__id' | 'pair__reserve0' | 'pair__reserve1' | 'pair__totalSupply' | 'pair__reserveETH' | 'pair__reserveUSD' | 'pair__trackedReserveETH' | 'pair__token0Price' | 'pair__token1Price' | 'pair__volumeToken0' | 'pair__volumeToken1' | 'pair__volumeUSD' | 'pair__untrackedVolumeUSD' | 'pair__txCount' | 'pair__createdAtTimestamp' | 'pair__createdAtBlockNumber' | 'pair__liquidityProviderCount' | 'liquidityTokenBalance';
export type Mint = {
    id: Scalars['ID'];
    transaction: Transaction;
    timestamp: Scalars['BigInt'];
...
export type Mint_orderBy = 'id' | 'transaction' | 'transaction__id' | 'transaction__blockNumber' | 'transaction__timestamp' | 'timestamp' | 'pair' | 'pair__id' | 'pair__reserve0' | 'pair__reserve1' | 'pair__totalSupply' | 'pair__reserveETH' | 'pair__reserveUSD' | 'pair__trackedReserveETH' | 'pair__token0Price' | 'pair__token1Price' | 'pair__volumeToken0' | 'pair__volumeToken1' | 'pair__volumeUSD' | 'pair__untrackedVolumeUSD' | 'pair__txCount' | 'pair__createdAtTimestamp' | 'pair__createdAtBlockNumber' | 'pair__liquidityProviderCount' | 'to' | 'liquidity' | 'sender' | 'amount0' | 'amount1' | 'logIndex' | 'amountUSD' | 'feeTo' | 'feeLiquidity';
export type Pair = {
    id: Scalars['ID'];
    token0: Token;
    token1: Token;
...
export type PairHourData_orderBy = 'id' | 'hourStartUnix' | 'pair' | 'pair__id' | 'pair__reserve0' | 'pair__reserve1' | 'pair__totalSupply' | 'pair__reserveETH' | 'pair__reserveUSD' | 'pair__trackedReserveETH' | 'pair__token0Price' | 'pair__token1Price' | 'pair__volumeToken0' | 'pair__volumeToken1' | 'pair__volumeUSD' | 'pair__untrackedVolumeUSD' | 'pair__txCount' | 'pair__createdAtTimestamp' | 'pair__createdAtBlockNumber' | 'pair__liquidityProviderCount' | 'reserve0' | 'reserve1' | 'reserveUSD' | 'hourlyVolumeToken0' | 'hourlyVolumeToken1' | 'hourlyVolumeUSD' | 'hourlyTxns';
...
export type Pair_orderBy = 'id' | 'token0' | 'token0__id' | 'token0__symbol' | 'token0__name' | 'token0__decimals' | 'token0__totalSupply' | 'token0__tradeVolume' | 'token0__tradeVolumeUSD' | 'token0__untrackedVolumeUSD' | 'token0__txCount' | 'token0__totalLiquidity' | 'token0__derivedETH' | 'token1' | 'token1__id' | 'token1__symbol' | 'token1__name' | 'token1__decimals' | 'token1__totalSupply' | 'token1__tradeVolume' | 'token1__tradeVolumeUSD' | 'token1__untrackedVolumeUSD' | 'token1__txCount' | 'token1__totalLiquidity' | 'token1__derivedETH' | 'reserve0' | 'reserve1' | 'totalSupply' | 'reserveETH' | 'reserveUSD' | 'trackedReserveETH' | 'token0Price' | 'token1Price' | 'volumeToken0' | 'volumeToken1' | 'volumeUSD' | 'untrackedVolumeUSD' | 'txCount' | 'createdAtTimestamp' | 'createdAtBlockNumber' | 'liquidityProviderCount';
export type Swap = {
    id: Scalars['ID'];
    transaction: Transaction;
    timestamp: Scalars['BigInt'];
...
export type Swap_orderBy = 'id' | 'transaction' | 'transaction__id' | 'transaction__blockNumber' | 'transaction__timestamp' | 'timestamp' | 'pair' | 'pair__id' | 'pair__reserve0' | 'pair__reserve1' | 'pair__totalSupply' | 'pair__reserveETH' | 'pair__reserveUSD' | 'pair__trackedReserveETH' | 'pair__token0Price' | 'pair__token1Price' | 'pair__volumeToken0' | 'pair__volumeToken1' | 'pair__volumeUSD' | 'pair__untrackedVolumeUSD' | 'pair__txCount' | 'pair__createdAtTimestamp' | 'pair__createdAtBlockNumber' | 'pair__liquidityProviderCount' | 'sender' | 'amount0In' | 'amount1In' | 'amount0Out' | 'amount1Out' | 'to' | 'logIndex' | 'amountUSD';
export type Token = {
    id: Scalars['ID'];
    symbol: Scalars['String'];
    name: Scalars['String'];
...
export type Token_orderBy = 'id' | 'symbol' | 'name' | 'decimals' | 'totalSupply' | 'tradeVolume' | 'tradeVolumeUSD' | 'untrackedVolumeUSD' | 'txCount' | 'totalLiquidity' | 'derivedETH' | 'mostLiquidPairs';
...
export type UniswapDayData_orderBy = 'id' | 'date' | 'dailyVolumeETH' | 'dailyVolumeUSD' | 'dailyVolumeUntracked' | 'totalVolumeETH' | 'totalLiquidityETH' | 'totalVolumeUSD' | 'totalLiquidityUSD' | 'maxStored' | 'mostLiquidTokens' | 'txCount';
...
export type UniswapFactory_orderBy = 'id' | 'pairCount' | 'totalVolumeUSD' | 'totalVolumeETH' | 'untrackedVolumeUSD' | 'totalLiquidityUSD' | 'totalLiquidityETH' | 'txCount' | 'mostLiquidTokens';
export type User = {
    id: Scalars['ID'];
...
export declare function getBuiltGraphSDK<TGlobalContext = any, TOperationContext = any>(globalContext?: TGlobalContext): {
    ExampleQuery(variables?: Exact<{
        [key: string]: never;
    }>, options?: TOperationContext): Promise<ExampleQueryQuery>;
};
